...
villager_count = st.slider('村民数量', min_value=0, max_value=player_count, value=int(player_count / 3))
wolf_count = st.slider('狼人数量（包括特殊狼）', min_value=0, max_value=player_count, value=int(player_count / 3))
gods = st.multiselect('选择神职', options=['预言家', '女巫', '猎人', '守卫', '骑士', '长老', '白痴', '驯熊师'],
